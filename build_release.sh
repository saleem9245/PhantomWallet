...
# zip
zip -r bin/release/PhantomWallet-0-7-6-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-7-6-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-7-6-osx.zip bin/PhantomWallet-osx
