...
# zip
zip -r bin/release/PhantomWallet-0-4-9-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-4-9-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-4-9-osx.zip bin/PhantomWallet-osx
