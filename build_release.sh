...
# zip
zip -r bin/release/PhantomWallet-0-6-3-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-6-3-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-6-3-osx.zip bin/PhantomWallet-osx
