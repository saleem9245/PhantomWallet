...
# zip
zip -r bin/release/PhantomWallet-0-8-1-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-8-1-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-8-1-osx.zip bin/PhantomWallet-osx
