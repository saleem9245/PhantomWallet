...
# zip
zip -r bin/release/PhantomWallet-0-6-5-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-6-5-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-6-5-osx.zip bin/PhantomWallet-osx
