...
# zip
zip -r bin/release/PhantomWallet-0-4-5-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-4-5-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-4-5-osx.zip bin/PhantomWallet-osx
