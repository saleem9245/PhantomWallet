...
# zip
zip -r bin/release/PhantomWallet-0-5-7-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-5-7-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-5-7-osx.zip bin/PhantomWallet-osx
