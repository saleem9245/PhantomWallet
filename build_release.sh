...
# zip
zip -r bin/release/PhantomWallet-0-6-8-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-6-8-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-6-8-osx.zip bin/PhantomWallet-osx
