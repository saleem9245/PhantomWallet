...
# zip
zip -r bin/release/PhantomWallet-0-5-6-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-5-6-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-5-6-osx.zip bin/PhantomWallet-osx
