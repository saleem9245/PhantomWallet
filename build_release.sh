...
# zip
zip -r bin/release/PhantomWallet-0-5-4-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-5-4-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-5-4-osx.zip bin/PhantomWallet-osx
