...
# zip
zip -r bin/release/PhantomWallet-0-5-8-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-5-8-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-5-8-osx.zip bin/PhantomWallet-osx
