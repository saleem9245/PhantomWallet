...
# zip
zip -r bin/release/PhantomWallet-0-7-4-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-7-4-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-7-4-osx.zip bin/PhantomWallet-osx
