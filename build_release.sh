...
# zip
zip -r bin/release/PhantomWallet-0-8-0-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-8-0-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-8-0-osx.zip bin/PhantomWallet-osx
