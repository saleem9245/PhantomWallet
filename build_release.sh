...
# zip
zip -r bin/release/PhantomWallet-0-6-7-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-6-7-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-6-7-osx.zip bin/PhantomWallet-osx
